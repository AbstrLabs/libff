...
public:
    ...
    mcl::bn256::G2 pt;
    mcl_bn128_G2();
    mcl_bn128_G2(const std::string& x0, const std::string& x1, const std::string& y0, const std::string& y1, const std::string& z0, const std::string& z1);
    ...
    static void batch_to_special_all_non_zeros(std::vector<mcl_bn128_G2> &vec);
};
